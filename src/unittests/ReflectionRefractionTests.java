...
public class ReflectionRefractionTests {
	...
	public void trianglesSphere() {
		...
		scene.geometries.add( //
				...
				new Triangle(new Point3D(-150, -150, -115), new Point3D(-70, 70, -140), new Point3D(75, 75, -150)) //
						.setMaterial(new Material().setKD(0.5).setKS(0.5).setnShininess(60).setkR(1)), //
				new Sphere(new Point3D(60, 50, -50), 30) //
						.setEmmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKD(0.2).setKS(0.2).setnShininess(30).setkT(0.6)),
				new Sphere(new Point3D(-20, 0, -50), 30) //
						.setEmmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKD(0.2).setKS(0.2).setnShininess(30).setkT(1)));

		scene.lights.add(new SpotLight(new Color(700, 400, 400), new Point3D(60, 50, 0), new Vector(0, 0, -1)) //
				.setKl(4E-5).setKq(2E-7));

		ImageWriter imageWriter = new ImageWriter("trianglesSphere", 600, 600);
		Render render = new Render() //
				.setImageWriter(imageWriter) //
				.setCam(camera) //
				.setRayTracer(new RayTracerBasic(scene));
